  ...
  const renderForm = () => {
    const formData = [
      ...
      },
      {
        ...
        other: false,
        values: [
          { label: "Yes ! Ofcourse.", value: "yes", selected: false },
          { label: "Not Really.", value: "no", selected: false },
        ],
      },
      {
        ...
        values: [
          ...
          { label: "Tailored Titles", value: "titles", selected: false },
          {
            label: "Easy Whatsapp Sharing",
            value: "whatsapp",
            selected: false,
          },
          { label: "VFC File Download", value: "vfc", selected: false },
          {
            label: "Business Friendly Design",
            value: "business",
            selected: false,
          ...
          { label: "Ease of Access", value: "ease", selected: false },
        ],
      },
      {
        type: "textarea",
...
;
    ...
    $(formRef.current).html('');
    $(formRef.current).formRender({ jsonData });
