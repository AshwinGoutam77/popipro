...
export default function EditAbout({ token, APIDATA, Data, TitleData, MainData, PlanData }) {
        ...
        <div className="position-relative">
          {Data ? (
            <EditPlan
              ...
              APIDATA={APIDATA}
              MainData={MainData}
              in_subscription={TitleData?.card_description?.in_subscription}
              trial={TitleData?.card_description?.can_start_trial}
              message={TitleData?.card_description?.message}
            />
          ) : (
            ""
          )}
